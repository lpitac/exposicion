...
| ![Logo Fiador](https://github.com/lpitac/exposicion/blob/main/assets/img/logo_fiador.svg) | [Fiador](https://github.com/lpitac/fiador) es un software libre escrito en [Python] (https://www.python.org) que permite automatizar la creación del sitio web, listo para publicarse, basándose en la plantilla Exposición Virtual. <a href="https://udcgal-my.sharepoint.com/:u:/g/personal/l_pitac_udc_es/EZV8a3fDB11MjyJX_hW9j4kBonbKsP6gluycy_odu1MKQA?e=jGuWOX">| Descargar Fiador 1.0 |</a> |
|---|---|
